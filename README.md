...
> O sistema proposto pelo "Cofre inteligente" conterá informações aqui detalhadas. Dos usuários será armazenado o nome, CPF ou RG, telefone, CEP, E-mail, a sua agência( Opcional ), biometria e metas financeiras. Do dinheiro conterá a quantidade total, a quantidade de cada cédula e moeda. Além disso, conterá especificações de cada cédula e moeda, como espessura, estrutura(como o desenho da nota é organizado), para saber qual o valor de cada nota e moeda e se ela é verdadeira. 
É importante destacar que cada "Cofre Inteligente" terá uma mini sensor que detectará quando o usuário ou alguém for retirar ou armazenar uma quantidade de dinheiro, ele irá enviar uma mensagem ao dono do Cofre com a quantia e a pessoa que retirou esse dinheiro.
