...
> O sistema proposto pelo "Cofre inteligente" conterá informações aqui detalhadas. Dos usuários será armazenado o nome, CPF, telefone, CEP, E-mail e a sua agência( Opcional ). Do dinheiro conterá a quantidade total, a quantidade de cada cédula e moeda. Além disso, conterá especificações de cada cédula e moeda, como espessura, estrutura(como o desenho da nota é organizado), para saber qual o valor de cada nota e moeda e se ela é verdadeira.
É importante destacar que cada "Cofre Inteligente" terá uma mini sensor que detectará quando o usuario ou alguem for retirar uma quantidade elevada de dinheiro, ele irá envir uma mensagem ao dono do Cofre para confirmar a retirada do dinheiro.  
